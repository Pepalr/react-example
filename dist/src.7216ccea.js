...
},{"./factoryWithTypeCheckers":"../node_modules/prop-types/factoryWithTypeCheckers.js"}],"../node_modules/invariant/browser.js":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
  ...
  for (var i = 0, l = ranked.length; i < l; i++) {
    ...
    for (; index < max; index++) {
      ...
      if (dynamicMatch && !isRootUri) {
        ...
        !matchIsNotReserved ? "development" !== "production" ? (0, _invariant2.default)(false, "<Router> dynamic segment \"" + dynamicMatch[1] + "\" is a reserved name. Please use a different name in path \"" + route.path + "\".") : (0, _invariant2.default)(false) : void 0;
...
exports.redirectTo = exports.navigate = exports.isRedirect = exports.createMemorySource = exports.createHistory = exports.ServerLocation = exports.Router = exports.Redirect = exports.Match = exports.LocationProvider = exports.Location = exports.Link = undefined;
...
var Location = function Location(_ref) {
  ...
  return _react2.default.createElement(LocationContext.Consumer, null, function (context) {
    return context ? children(context) : _react2.default.createElement(LocationProvider, null, children);
  });
};
...
var LocationProvider = function (_React$Component) {
  ...
  LocationProvider.prototype.render = function render() {
    ...
    return _react2.default.createElement(LocationContext.Provider, { value: context }, typeof children === "function" ? children(context) : children || null);
  };
...
var ServerLocation = function ServerLocation(_ref2) {
  ...
  return _react2.default.createElement(LocationContext.Provider, {
    value: {
...
var Router = function Router(props) {
  return _react2.default.createElement(BaseContext.Consumer, null, function (baseContext) {
    return _react2.default.createElement(Location, null, function (locationContext) {
...
var RouterImpl = function (_React$PureComponent) {
  ...
  RouterImpl.prototype.render = function render() {
    ...
    if (match) {
      ...
      var clone = _react2.default.cloneElement(element, props, element.props.children ? _react2.default.createElement(Router, { primary: primary }, element.props.children) : undefined);
      ...
      return _react2.default.createElement(BaseContext.Provider, { value: { baseuri: uri, basepath: basepath } }, _react2.default.createElement(FocusWrapper, wrapperProps, clone));
    } else {
...
var FocusHandler = function FocusHandler(_ref3) {
  ...
  return _react2.default.createElement(FocusContext.Consumer, null, function (requestFocus) {
...
var FocusHandlerImpl = function (_React$Component2) {
  ...
  FocusHandlerImpl.prototype.render = function render() {
    ...
    }, domProps), _react2.default.createElement(FocusContext.Provider, { value: this.requestFocus }, this.props.children));
  };
...
var Link = forwardRef(function (_ref4, ref) {
  ...
  return _react2.default.createElement(BaseContext.Consumer, null, function (_ref5) {
    var basepath = _ref5.basepath,
        baseuri = _ref5.baseuri;
    return _react2.default.createElement(Location, null, function (_ref6) {
...
var Match = function Match(_ref7) {
  ...
  return _react2.default.createElement(BaseContext.Consumer, null, function (_ref8) {
    var baseuri = _ref8.baseuri;
    return _react2.default.createElement(Location, null, function (_ref9) {
...
var createRoute = function createRoute(basepath) {
  return function (element) {
    !(element.props.path || element.props.default || element.type === Redirect) ? "development" !== "production" ? (0, _invariant2.default)(false, "<Router>: Children of <Router> must have a `path` or `default` prop, or be a `<Redirect>`. None found on element type `" + element.type + "`") : (0, _invariant2.default)(false) : void 0;

    !!(element.type === Redirect && (!element.props.from || !element.props.to)) ? "development" !== "production" ? (0, _invariant2.default)(false, "<Redirect from=\"" + element.props.from + " to=\"" + element.props.to + "\"/> requires both \"from\" and \"to\" props when inside a <Router>.") : (0, _invariant2.default)(false) : void 0;

    !!(element.type === Redirect && !(0, _utils.validateRedirect)(element.props.from, element.props.to)) ? "development" !== "production" ? (0, _invariant2.default)(false, "<Redirect from=\"" + element.props.from + " to=\"" + element.props.to + "\"/> has mismatched dynamic segments, ensure both paths have the exact same dynamic segments.") : (0, _invariant2.default)(false) : void 0;
...
},{"react":"../node_modules/react/index.js","warning":"../node_modules/warning/browser.js","prop-types":"../node_modules/prop-types/index.js","invariant":"../node_modules/invariant/browser.js","create-react-context":"../node_modules/create-react-context/lib/index.js","react-lifecycles-compat":"../node_modules/react-lifecycles-compat/react-lifecycles-compat.es.js","react-dom":"../node_modules/react-dom/index.js","./lib/utils":"../node_modules/@reach/router/es/lib/utils.js","./lib/history":"../node_modules/@reach/router/es/lib/history.js"}],"Components/Menu.js":[function(require,module,exports) {
'use strict';
...
var Menu = function (_Component) {
  ...
  _createClass(Menu, [{
    key: 'onClickMenu',
    value: function onClickMenu(event) {
      (0, _router.navigate)(event.target.getAttribute('href'));
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'nav',
        { className: 'menu navbar navbar-expand-lg navbar-light bg-light' },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'nav-link', onClick: this.onClickMenu, href: '/' },
              'Inicio ',
              _react2.default.createElement(
                'span',
                { className: 'sr-only' },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'nav-link', onClick: this.onClickMenu, href: 'contacto' },
              'Contacto'
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'nav-link', onClick: this.onClickMenu, href: 'ubicacion' },
              'Ubicaci\xF3n'
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'a',
              { className: 'nav-link dropdown-toggle', href: 'productos.html', id: 'navbarDropdown', role: 'button', 'data-toggle': 'dropdown', 'aria-haspopup': 'true', 'aria-expanded': 'false' },
              'Productos ',
              _react2.default.createElement(
                'span',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'a',
                { className: 'dropdown-item', href: 'productos.html' },
                'Todos los productos'
              ),
              _react2.default.createElement(
                'a',
...
},{"react":"../node_modules/react/index.js","@reach/router":"../node_modules/@reach/router/es/index.js"}],"Components/Header.js":[function(require,module,exports) {
"use strict";
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          "p",
          { className: "lead" },
          "Bienvenidos a la tienda de verduras de Pedrezuela"
        ),
...
},{"react":"../node_modules/react/index.js"}],"Components/Image.js":[function(require,module,exports) {
"use strict";
...
var Image = function Image() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement("img", { className: "card-img", src: "https://ep01.epimg.net/elpais/imagenes/2017/09/18/buenavida/1505749730_043697_1505751011_noticia_normal_recorte1.jpg", alt: "Card image" }),
    _react2.default.createElement("div", { className: "card-img-overlay" })
  );
};
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement("input", { type: "text", className: "form-control", id: "exampleFormControlInput1", required: true })
      ),
      _react2.default.createElement(
        "div",
        { className: "form-group" },
        ...
        _react2.default.createElement("input", { type: "email", className: "form-control", id: "exampleFormControlInput1", placeholder: "name@example.com", required: true })
      ),
      _react2.default.createElement(
        "div",
        { className: "form-group" },
        _react2.default.createElement(
          ...
          "N\xFAmero de raciones de verdura que come al d\xEDa"
        ),
        _react2.default.createElement(
          "select",
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement("textarea", { className: "form-control", id: "exampleFormControlTextarea1", rows: "3", required: true })
      ),
      _react2.default.createElement(
        "div",
        { id: "enviar" },
        _react2.default.createElement("input", { type: "submit", className: "btn btn-info", value: "Enviar" }),
        _react2.default.createElement(
          "a",
          { className: "btn btn-primary", href: "index.html", role: "button" },
          "Atr\xE1s"
        )
      )
    )
...
},{"react":"../node_modules/react/index.js"}],"Components/Ubication.js":[function(require,module,exports) {
'use strict';
...
var Ubication = function (_Component) {
  _inherits(Ubication, _Component);

  function Ubication() {
    _classCallCheck(this, Ubication);

    return _possibleConstructorReturn(this, (Ubication.__proto__ || Object.getPrototypeOf(Ubication)).apply(this, arguments));
  }

  _createClass(Ubication, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { id: 'map', className: 'card bg-dark text-white' },
          'Google Map'
        )
      );
    }
...
exports.default = Ubication;
},{"react":"../node_modules/react/index.js"}],"routes.js":[function(require,module,exports) {
'use strict';
...
var _Ubication = require('./Components/Ubication');

var _Ubication2 = _interopRequireDefault(_Ubication);
...
var Routes = function Routes() {
  return _react2.default.createElement(
    _router.Router,
    null,
    _react2.default.createElement(_Image2.default, { path: '/' }),
    _react2.default.createElement(_Contact2.default, { path: '/contacto' }),
    _react2.default.createElement(_Ubication2.default, { path: '/ubicacion' })
  );
};

exports.default = Routes;
},{"react":"../node_modules/react/index.js","@reach/router":"../node_modules/@reach/router/es/index.js","./Components/Image":"Components/Image.js","./Components/Contact":"Components/Contact.js","./Components/Ubication":"Components/Ubication.js"}],"index.js":[function(require,module,exports) {
'use strict';
...
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./Components/Menu":"Components/Menu.js","./Components/Header":"Components/Header.js","./Components/Image":"Components/Image.js","./routes":"routes.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/src.7216ccea.map